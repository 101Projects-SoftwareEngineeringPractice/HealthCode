...
public class UserServiceImpl implements UserService {
    ...
    public String userLogin(String code) {
        ...
        try {
            ...
            logger.error("Failed to login user with code: {}, error: {}", code, e.getMessage());
        }
    ...
    public void manageOpposite(long mid) {
        ...
        if (uerDao == null) {
            logger.error("Health code manager not found for MID: {}", mid);
    ...
    public String userLogin_test(String code) {
        ...
        if (!exists) {
            try {
                ...
                logger.error("Failed to add new user mapping for openID: {}, error: {}", openID, e.getMessage());
            ...
            try {
                ...
                logger.error("Failed to get UID for openID: {}, error: {}", openID, e.getMessage());
                uid = IdUtil.getSnowflake().nextId();
                UidMappingDao uidMappingDao = new UidMappingDao();
                uidMappingDao.setUid(uid);
                uidMappingDao.setOpenid(openID);
