...
public enum ExceptionEnum {
    ...
    ITINERARY_CODE_INSERT_FAIL("40001", "核酸记录添加失败"),
    ITINERARY_CODE_UPDATE_FAIL("40002", "核酸记录更新失败"),
    ITINERARY_CODE_DELETE_FAIL("40003", "核酸记录删除失败"),
    ITINERARY_CODE_SELECT_FAIL("40004", "核酸记录查询失败"),
